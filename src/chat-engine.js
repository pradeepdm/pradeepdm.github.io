/*
* This file is using PubNub Chat Engine SDK to establish a communication channel
* between the pharmacist and the customer.
*
* Dependencies: generate-person.js.
*
* */
...
// Using generate-person.js to read some random data for chat display
